...
CREATE TABLE SHIPPINGCONFIG (
  ...
  STATE TEXT NOT NULL,
  PRICE BIGINT(20) NOT NULL,
  WEIGHT_CARRY_FROM BIGINT(20) NOT NULL,
  WEIGHT_CARRY_TO BIGINT(20) NOT NULL,
...
ALTER TABLE PRODUCT ADD STATUS TEXT;

ALTER TABLE PRODUCT ADD TOTAL_ORDER BIGINT(20);
